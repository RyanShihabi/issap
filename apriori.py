...
def run_apriori(facility_data):
    ...
    apriori_df = apriori_from_list(apriori_list, "", save=True)
    association_df = association_from_apriori(apriori_df)

    apriori_without_exercise_df = apriori_from_list(apriori_list_without_exercise, "_without_exercise", save=True)
    association_without_exercise_df = association_from_apriori(apriori_without_exercise_df)
